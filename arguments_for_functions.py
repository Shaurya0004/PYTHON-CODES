...
'''
this is giving error because in python, if we are having default 
arguments then there should not be any other type of arguments
(except for variable length arguments) on the right of default arguments. 
'''
# 	return x*y*z*a
