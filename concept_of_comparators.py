...
result = sorted(li_new) # it returns a new sorted list-->> so basically if you want to
                        # return a new list and want to retain the old(original one)
                        # then use-->> sorted(li)  <<-- and if you rather want to make
                        # changes to the original list then use --> li.sort  <<--  
